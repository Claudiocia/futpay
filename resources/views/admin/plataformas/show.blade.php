                ...
                <div class="col-md-12">
                    <div class="w-auto p-3">
                        <div class="panel-heading-admin">
                            <h5>Plataforma {{ $plataforma->name }}</h5>
                        </div>
                        <div class="panel-body">
                            <div class="row btn-new-reset">
                                <p><a href="{{route('admin.plataformas.edit', ['plataforma' => $plataforma->id])}}" class="btn btn-primary btn-assinar">Editar</a></p>
                                <p><a href="{{route('admin.plataformas.index')}}" class="btn btn-success btn-assinar">Voltar</a></p>
                                ...
                                <?php $formDelete = FormBuilder::plain([
                                    'id' => 'form-delete',
                                    'route' => ['admin.plataformas.destroy', 'plataforma' => $plataforma->id],
                                    'method' => 'DELETE',
                                    'style' => 'display:none',
                                ]); ?>
                                {!! form($formDelete) !!}
