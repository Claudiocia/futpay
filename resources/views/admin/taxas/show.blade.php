                ...
                <div class="col-md-12">
                    <div class="w-auto p-3">
                        <div class="panel-heading-admin">
                            <h5>Taxa {{ $taxa->operation }}</h5>
                        </div>
                        <div class="panel-body">
                            <div class="row btn-new-reset">
                                <p><a href="{{route('admin.taxas.edit', ['taxa' => $taxa->id])}}" class="btn btn-primary btn-assinar">Editar</a></p>
                                <p><a href="{{route('admin.taxas.index')}}" class="btn btn-success btn-assinar">Voltar</a></p>
                                ...
                                <?php $formDelete = FormBuilder::plain([
                                    'id' => 'form-delete',
                                    'route' => ['admin.taxas.destroy', 'taxa' => $taxa->id],
                                    'method' => 'DELETE',
                                    'style' => 'display:none',
                                ]); ?>
                                {!! form($formDelete) !!}
